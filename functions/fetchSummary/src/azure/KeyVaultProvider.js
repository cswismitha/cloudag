...
var KeyVaultProvider = /** @class */ (function () {
    function KeyVaultProvider() {
        var url = config_1["default"].vault;
        var credential = new identity_1.DefaultAzureCredential({
            managedIdentityClientId: config_1["default"].clientID
        });
        this.client = new keyvault_secrets_1.SecretClient(url, credential);
    }
    KeyVaultProvider.prototype.getSecret = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var secret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.getSecret(name)];
                    case 1:
                        secret = _a.sent();
